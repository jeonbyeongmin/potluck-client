      ...
      <List>
        <Link href={'/parties/1'}>
          <ListItem active={router.asPath === '/parties/1'}>
            ...
            <Text size="sm">프론트엔드 정보</Text>
          </ListItem>
        </Link>
        <Link href={'/parties/2'}>
          <ListItem active={router.asPath === '/parties/2'}>
            <Avatar shape="square" src="https://i.pravatar.cc/301" />
            <Text size="sm">파티 이름 입니다</Text>
          </ListItem>
        </Link>
        <Link href={'/parties/3'}>
          <ListItem active={router.asPath === '/parties/3'}>
            <Avatar shape="square" src="https://i.pravatar.cc/302" />
            <Text size="sm">파티 이름 입니다</Text>
          </ListItem>
        </Link>
        <Link href={'/parties/4'}>
          <ListItem active={router.asPath === '/parties/4'}>
            <Avatar shape="square" src="https://i.pravatar.cc/303" />
            <Text size="sm">파티 이름 입니다</Text>
          </ListItem>
        </Link>
        <Link href={'/parties/5'}>
          <ListItem active={router.asPath === '/parties/5'}>
            <Avatar shape="square" src="https://i.pravatar.cc/304" />
            <Text size="sm">파티 이름 입니다</Text>
          </ListItem>
        </Link>
      </List>
